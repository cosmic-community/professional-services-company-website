        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              We help businesses thrive in the digital age with innovative solutions, 
              expert consulting, and cutting-edge technology implementations.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li>
                <a href="mailto:info@company.com" className="hover:text-white transition-colors duration-300">
                  info@company.com
                </a>
              </li>
              <li>
